...
public class DorosleWynikiAdmin extends AppCompatActivity {
    ListView listt;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dorosle_wyniki_admin);
        ...
        doroslee.orderByChild("punktyFinalne").limitToLast(10).addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot postSnapshot: dataSnapshot.getChildren())
                {
                    ...
                    AdapterListyAdminDorosle myAdapterr = new AdapterListyAdminDorosle(DorosleWynikiAdmin.this,DorosleList);
